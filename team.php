<?php
$page_title = 'Team — PlusWealth PMS';
include 'header.php';
?>

<!-- TEAM -->
<div class="section-wrap alt" id="team">
  <div class="inner">
    <div class="s-eyebrow reveal">The Team</div>
    ...
    <div class="team-grid">
      <div class="t-card reveal d1">
        ...
        <ul class="t-skills">
          <li>Multi-asset systematic trading strategies</li>
          <li>Market microstructure & statistical modelling</li>
          <li>Risk management & regulatory compliance</li>
        </ul>
        <div class="t-creds">
          B.Com, Delhi University (2001)<br>
          NISM: Equity & Currency Derivatives<br>
          NISM: Mutual Funds · Securities Compliance
        </div>
      </div>
      ...
      <div class="t-card reveal d2">
        ...
        <div class="t-divider"></div>
        <ul class="t-skills">
          <li>Quantitative model development</li>
          <li>Advanced options strategies & derivatives</li>
          <li>Correlation modelling, systematic portfolio construction</li>
        </ul>
        <div class="t-creds">
          B.Com(H), Hindu College DU (1995)<br>
          MBA, FORE School of Management (1998)<br>
          NISM: Derivatives (2019)
        </div>
      </div>
      ...
      <div class="t-card reveal d3">
        ...
        <div class="t-divider"></div>
        <ul class="t-skills">
          <li>Investment research & portfolio evaluation</li>
          <li>Credit risk analytics across sectors</li>
          <li>Business analytics (ex-Groww)</li>
        </ul>
        <div class="t-creds">
          B.Com(H), Shri Ram College of Commerce<br>
          CFA Program — All 3 levels cleared
        </div>
      </div>
    </div>
  </div>
